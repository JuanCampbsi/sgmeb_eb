...
public class Consulta implements Serializable {
	...
	@IdentificaCampoPesquisa(descricaoCampo = "Consulta", campoConsulta = "cons_id")
	@Id
	...
	@IdentificaCampoPesquisa(descricaoCampo = "Situação", campoConsulta = "sit_paci", principal = 1)
	@Column(length = 100, nullable = false)
	private String sit_paci;

	@IdentificaCampoPesquisa(descricaoCampo = "Prescrição", campoConsulta = "presc_paci", principal = 1)
	@Column(length = 500, nullable = false)
	private String presc_paci;

	@IdentificaCampoPesquisa(descricaoCampo = "Histórico", campoConsulta = "hist_cons", principal = 1)
	@Column(length = 100, nullable = false)
